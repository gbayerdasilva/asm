      ...
      <div class="container">
        <div class="row centered">
          <div class="col-lg-12">
            ...
            <h3>Resumo de horas totais, disponíveis e manutenções</h3>
            <br>
          </div>
  ...
  <section id="desc" name="desc">
    ...
    <div id="intro">
      <div class="container">
        <div class="row centered">
          <h4>	Horas totais: 
<br>		Horas disponíveis até próxima inspeção: 
<br>		Horas disponíveis até TBO: 
          <br>
<br>
<br>
		<form action="mx.php?" method="GET">
			<input type="hidden" value="1" id="set">
			<input type="submit" value="Registrar MX" id="reg">
		</form>
