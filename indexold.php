...
<head>
  ...
  <!-- Favicons -->
  <link href="pages/img/favicon.png" rel="icon">
  <link href="pages/img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic|Raleway:400,300,700" rel="stylesheet">

  <!-- Bootstrap CSS File -->
  <link href="pages/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand smothscroll" href="index.php"><b><img border="0" src="pages/img/asm.jpg" width="30" height="30"></b></a>
      </div>
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li class="active"><a href="index.php">Escala</a></li>

          <li><a href="login/index.php"><span text-align: right> Login </span></a></li>
        </ul>
      </div>
      <!--/.nav-collapse -->
    </div>
